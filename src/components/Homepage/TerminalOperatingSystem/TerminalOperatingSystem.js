...
const TerminalOperatingSystem = () => {
  return (
    <div
      className="container  pt-16 mx-auto min-h-[900px] flex flex-col justify-between bg-no-repeat "
      style={{
        backgroundImage: `url(${"https://rbs-tops.com/wp-content/uploads/2019/09/waters.png"})`,
        backgroundPosition: "50% 0%",
        backgroundSize: "100% 100%",
      }}
    >
      <div className="max-w-7xl w-full  mx-auto min-h-[900px] flex flex-col justify-between bg-no-repeat ">
        <div className="max-w-7xl w-full flex flex-col lg:flex-row  ">
          <div className="w-1/2 flex flex-col mt-32 gap-10">
            ...
            <p>
              ...
              essence of the supply chain fuelling globalization. Primarily, a
              TOS is a powerful system connecting all areas of a terminal and
              offers a full scope of capabilities to ensure operations are
              planned accurately and executed efficiently. Our state-of-the-art
              TOS provides complete control, planning, and monitoring
              functionalities to achieve performance fulfilled in the form of
              optimized operations and resources.
              <br />
              <br />
              <br />
              RBS has a large focus on its customers and has spent an incredible
              amount of effort and investment in Research and Development in
              order to create value for its customers.
              <br />
              <br />
              <br />
              By listening and adapting to customers’ needs, RBS has been able
              to develop the latest products called TOPS Expert and TOPS Expert
